...
PreparedStatement pst;
    ...
    public  void Random()
    {
        ...
        jTextField1.setText("CM-"+rd.nextInt(1000+1));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(657, 510, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 50, 30, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 50, 30, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\CM Chandan\\Desktop\\HMS\\addheader.png")); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 1280, -1));
        ...
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(657, 594, -1, -1));

        jComboBox2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Outdoor", "Indoor", " " }));
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 510, 270, 40));

        jTextField10.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(875, 589, 270, 43));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(28, 164, -1, 660));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jComboBox1, javax.swing.GroupLayout.Alignment.TRAILING, 0, 267, Short.MAX_VALUE)
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(648, 164, -1, -1));

        jButton3.setIcon(new javax.swing.ImageIcon("C:\\Users\\CM Chandan\\Desktop\\HMS\\addbtn.png")); // NOI18N
        jButton3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 102, 255), new java.awt.Color(0, 102, 255), new java.awt.Color(0, 153, 204), new java.awt.Color(0, 102, 255)));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 690, 130, 50));

        jButton4.setIcon(new javax.swing.ImageIcon("C:\\Users\\CM Chandan\\Desktop\\HMS\\back.jpg")); // NOI18N
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1230, 140, 60, 50));
...
obj.setVisible(true);            // TODO add your handling code here:
    ...
    String sql="insert into addp1(patientid,firstname,age,maritialstatus,address,city,ward,date,lastname,gender,phone,patienttype,bed) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
try{
    ...
    pst.execute();
      JOptionPane.showMessageDialog(null,"Patient Sucessfully Add");
      setVisible(false);
      Patientp obj=new Patientp();
      obj.setVisible(true);
}   catch (Exception e) {
