 ...
 * @author CM Chandan
 */
public class Patientp extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Patientp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
