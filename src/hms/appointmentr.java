 ...
 * @author CM Chandan
 */
public class appointmentr extends javax.swing.JFrame {
Connection conn;
ResultSet rs;
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 1340, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1270, 140, 60, 50));

        jLabel9.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 153, 255));
        jLabel9.setText("Specialized");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 580, -1, -1));
        ...
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 660, -1, -1));

        jTextField15.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        getContentPane().add(jTextField15, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 650, 260, 40));

        jButton5.setIcon(new javax.swing.ImageIcon("C:\\Users\\CM Chandan\\Desktop\\HMS\\addappointmentbtn.png")); // NOI18N
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 720, 260, 50));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 570, 260, 40));
...
setVisible(false);
ReceptionPortal obj=new ReceptionPortal();
...
try{
 ...
 String sql="insert into appointment(patientid,firstname,age,maritialstatus,address,city,wardno,lastname,date,gender,phone,specialized,appointment_date) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
try{
     pst=conn.prepareStatement(sql);
    pst.setString(1,jTextField1.getText());
    ...
    pst.execute();
      JOptionPane.showMessageDialog(null,"Appointment Sucessfully Add");
      jTextField1.setText("");
     jTextField2.setText("");
      jTextField3.setText("");
       jTextField4.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(appointmentr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new appointmentr().setVisible(true);
            }
        });
    }
